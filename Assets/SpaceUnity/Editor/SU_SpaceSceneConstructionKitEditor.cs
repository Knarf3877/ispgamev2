...
public class SU_SpaceSceneConstructionKitEditor : EditorWindow {
    ...
    void OnGUI () {
		...
		_galaxyColors = (GalaxyColors) EditorGUILayout.EnumFlagsField("Galaxy Colors", _galaxyColors);		
		_galaxyDistance = (GalaxyDistance) EditorGUILayout.EnumFlagsField("Galaxy Distance:", _galaxyDistance);
